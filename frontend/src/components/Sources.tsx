...
/**
 * Sources component displays a list of sources with favicons, hyperlinks, and a copy-to-clipboard feature.
 * 
 * Props:
 * - sources: array of source objects (title, link, favicon, etc.)
 * - title: section heading (i.e. "Cited Sources")
 * 
 */
    ...
    return (
        <div className="flex flex-col gap-3 bg-orange-50 border-l-5 border-orange-200 px-3 py-5 w-full">
            ...
            {sources.map(source => (
                ...
                ? <Image src={source.favicon_url} alt="" aria-hidden="true" role="presentation" width={16} height={16} />
